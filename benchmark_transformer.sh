...
CMD="python train.py --encoder-type resnet18 --decoder-type transformer --num-heads 1 --num-tf-layers 3 --fine-tune 1 --experiment-name resnet18_bs64_ft1_l3_h1"
run_experiment "$CMD" "resnet18_bs64_ft1_l3_h1"

CMD="python train.py --encoder-type resnet101 --decoder-type transformer --num-heads 1 --num-tf-layers 3 --fine-tune 1 --experiment-name resnet101_bs64_ft1_l3_h1"
run_experiment "$CMD" "resnet101_bs64_ft1_l3_h1"
